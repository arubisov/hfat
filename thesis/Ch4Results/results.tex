...
A symmetry is evident between $\delta^\pm$ for opposite Markov chain states. For example, in figure <INSERT HERE> we compare $\delta^+$ for z=1 with $\delta^-$ for z = 15. It's almost a mirror image. Also o
