...
\begin{figure}
  ...
  \resizebox{\linewidth}{!}{\input{Figs/LOBtimeline.tikz}}
...
\begin{subfigure}{.45\linewidth}
  ...
  \tikzsetnextfilename{FARO_naive_strat_comp}
  \input{Figs/FARO_naive_strat_comp.tikz}
\end{subfigure}%
\hfill%
\begin{subfigure}{.45\linewidth}
  \centering
  \setlength\figureheight{\linewidth} 
  \setlength\figurewidth{\linewidth}
  \tikzsetnextfilename{NTAP_naive_strat_comp}
  \input{Figs/NTAP_naive_strat_comp.tikz} 
\end{subfigure}\\
\vspace{1cm}
\begin{subfigure}{.45\linewidth}
  \centering
  \setlength\figureheight{\linewidth} 
  \setlength\figurewidth{\linewidth}
  \tikzsetnextfilename{ORCL_naive_strat_comp}
  \input{Figs/ORCL_naive_strat_comp.tikz} 
\end{subfigure}%
\hfill%
\begin{subfigure}{.45\linewidth}
  \centering
  \setlength\figureheight{\linewidth} 
  \setlength\figurewidth{\linewidth}
  \tikzsetnextfilename{INTC_naive_strat_comp}
  \input{Figs/INTC_naive_strat_comp.tikz} 
\end{subfigure}\\
...
\begin{subfigure}{\linewidth}
  \centering
  \tikzsetnextfilename{naivestratlegend}
  \input{Figs/naivestratlegend.tikz} 
\end{subfigure}%
