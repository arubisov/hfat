...
\end{split}
\end{align}
\mynote{section on compensated processes, especially for Markov Chain}
...
\end{align}
\mynote{insert the little bubbles with sell and buy at the inequatlity signs. sell, buy, buy, sell left right top down.}
