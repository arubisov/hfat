...
\begin{theorem}[\cite{STA4505}] \textbf{Dynamic Programming Principle for Optimal Stopping and Control.}
...
\end{theorem}
\begin{theorem}[\cite{STA4505}] \textbf{Dynamic Programming Equation for Optimal Stopping and Control.}
...
\end{split}
\end{align}
TODO: section on compensated processes, especially for Markov Chain
...
\end{align}
TODO: insert the little bubbles with sell and buy at the inequatlity signs. sell, buy, buy, sell left right top down. 
