...
\fxnote{better lead in to this section. also clean up this presentation of the stochastic processes... somehow more effectively...}
...
\end{align}
An identical derivation holds for sell market orders. In the next chapter this will allow us to gauge the market order behaviour by viewing only the limit order posting depths.