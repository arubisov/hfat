...
From equation \eqref{eq:buyMOfeedbackcase1}, we know that a buy market order is executed under the condition:
\begin{align}
...
& \iff \begin{cases} {\delta^+}^* = \frac{1}{\kappa} -2 \xi, \quad q \geq 0 \\
{\delta^+}^* =  \frac{1}{\kappa} - 2 \xi, \quad q < 0 \end{cases} \\
